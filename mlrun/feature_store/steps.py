...
class MapValues(StepToDict, MLRunStep):
        ...
        if encoded_mapping:
            ...
            if mapping:
                ...
                mlrun.errors.MLRunInvalidArgumentError(
                    "Mapvalues init must get at least one of the attributes mapping or encoded_mapping"
                )
    ...
    def validate_args(cls, feature_set, **kwargs):
        ...
        mapping = JsonNonStringKeysEncoder.decode(encoded_mapping) or kwargs.get(
            "mapping", []
        )
